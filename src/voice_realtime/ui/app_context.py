...
from voice_realtime.lm_studio import LMStudioClient
...
from voice_realtime.meeting.inner_os.repository import InnerOSExchangeRepository
...
from voice_realtime.meeting.ports import MeetingRepository
...
from voice_realtime.meeting.runtime_mode import MeetingWorkload
...
def attach_app_context(app: FastAPI, context: UIAppContext) -> None:
    app.state.voice_realtime_context = context


def get_app_context(app: FastAPI) -> UIAppContext:
    context = getattr(app.state, "voice_realtime_context", None)
