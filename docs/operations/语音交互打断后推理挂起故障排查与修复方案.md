...
description: "Voice Studio 语音交互在用户发声打断 (Barge-in) 时 LM Studio 推理挂起死锁故障的根因分析与状态机修复方案"
status: implemented
type: postmortem
...
- **核心文件**：[`src/voice_realtime/interaction/pipeline.py`](../../src/voice_realtime/interaction/pipeline.py#L193-L212)
- **机制机制**：
...
- **核心文件**：[`src/voice_realtime/interaction/pipeline.py`](../../src/voice_realtime/interaction/pipeline.py#L370-L410)
- **机制机制**：
...
- **核心文件**：[`src/voice_realtime/interaction/reasoning.py`](../../src/voice_realtime/interaction/reasoning.py#L471-L519)、[`context_memory.py`](../../src/voice_realtime/interaction/context_memory.py#L263-L308)
- **机制机制**：
