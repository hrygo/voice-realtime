...
public final class SPSCRingBuffer: @unchecked Sendable {
    ...
    public func push(
        ...
        var rawMetadata = SonaAudioCaptureRingMetadata(
        ...
        switch Int(result) {
        case SONA_AUDIO_CAPTURE_RING_PUSH_STORED:
            return .stored
        case SONA_AUDIO_CAPTURE_RING_PUSH_STORED_DROPPING_OLDEST:
            return .storedDroppingOldest
        case SONA_AUDIO_CAPTURE_RING_PUSH_DROPPED_INCOMING:
    ...
    public func pop(into destination: UnsafeMutableRawBufferPointer) -> RingPopResult? {
        ...
        var rawRecord = SonaAudioCaptureRingRecord()
